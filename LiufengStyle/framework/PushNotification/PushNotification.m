...
- (void)getApplicationIconBadgeNumber:(CDVInvokedUrlCommand *)command {
  ...
  [self.callbackIds setValue:command.callbackId forKey:@"getApplicationIconBadgeNumb                                      er"];
...
- (void)setApplicationIconBadgeNumber:(CDVInvokedUrlCommand *)command {
  ...
  [self.callbackIds setValue:command.callbackId forKey:@"setApplicationIconBadgeNumber"];
    DLog(@"setApplicationIconBadgeNumber:1");
   
  int badge = [[command.arguments objectAtIndex:0] intValue] ?: 0;
     DLog(@"setApplicationIconBadgeNumber:2");
  [[UIApplication sharedApplication] setApplicationIconBadgeNumber:badge];
 DLog(@"setApplicationIconBadgeNumber:3");
  NSMutableDictionary *results = [NSMutableDictionary dictionary];
