...
- (BOOL)connect
{
    ...
    NSLog(@"=connect===%@,%@",myJID,myPassword);
    //
...
{
    NSLog(@"===sendmessage==%@ to %@ ",newmessage,user);
...
- (void)xmppStream:(XMPPStream *)sender didReceiveMessage:(XMPPMessage *)message
{
    ...
    if ([message isChatMessageWithBody])
    {
        ...
        somMessage.fromXmppUser=user.displayName;
        somMessage.toXmppUser=toUser.displayName;
        somMessage.thumbnail=toUser.photo;
...
-(void)checkUserInfo
{
    ...
    NSMutableArray *userDictionary=(NSMutableArray *)[UserDefaultsHelper getDictForKey:@"user"];
    BOOL isLogin=true;
    
    if (userDictionary == nil) {
        NSLog(@"can't get user info , and skip login page !");
        ...
        NSLog(@" Get user info ,%@:%@:%@",username,password,xmppDomain);
